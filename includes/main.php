    ...
    <div class="page-header__topline">
      <div class="container clearfix">
        ...
        <div class="currency">
          ...
          { 
              echo "Welcome Back! " . $_SESSION['customer_email'] . "";
            }
?>
          </a>
        </div>
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="index.php">
            <img class="logo__img" src="images/logo.png" alt="mysawit logotype" width="237" height="19">
          </a>
        </div>
        ...
        <nav class="main-nav">
          <ul class="categories">
            ...
            <li class="categories__item">
              <a class="categories__link categories__link--active" href="admin_area/login.php">
                Admin
              </a>
            </li>
          <li class="categories__item">
